...
if __name__ == "__main__":
    ...
    business_date = next(
        iter(latest_key_rates['key_rates'].keys())
    )
    payload = {
    ...
    token_response = requests.post(
        url=RAPID_API_URL + "/curve_price_request/",
        json=payload,
        headers=headers)
    ...
    pricer_response = requests.post(
        url=RAPID_API_URL + "/curve_price_results/",
